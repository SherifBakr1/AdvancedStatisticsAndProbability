---
title: "Problem Set 3, Spring 2024"
author: "Sherif Bakr"
output: pdf_document
---
...
Your answer here: The intercept 
...
Your answer here: Intercept, fat_type_factorPeanut

Question C: Based on the output, which fat type had a *lower* mean than that of Canola oil? 

Your answer here: Sunflower oil (coefficient: -13.611)
...
Your answer here: Peanut oil, Shortening, Sunflower oil
...
Question C: Not counting the intercept, how many predictor coefficients in this model are associated with the *main effect* of flour type? Hint: ANOVA is a special case of regression and will not contradict the results of an equivalently-specified regression model.
...
prediction <- predict(doughnuts.reg, newdata = new_data)
print(prediction)

```

Your answer here: 47.3333
...
Your answer here: The points should be close to the horizontal line. The points should form a horizontal area.
...
Your answer here (left or right): The right side. 
...
Your answer here (list the observation number or numbers): 85 
...
#fish.remove <- # Complete this line
fish.remove <- fish[-85, ]
...
#fish.reg.remove <- # Complete this line
...
In Model 1, the p-value for fishpart_factor3 is 0.038461, which is below the alpha level of 0.05, indicating a significant result. Thus, the conclusion would be to reject the null hypothesis, so the coefficient is statistically significant.

In Model 2, the p-value for fishpart_factor3 is 0.32458, which is above the alpha level of 0.05. Thus, we fail to reject the null hypothesis, indicating that this coefficient is not statistically significant.

Thus, removing observation 85 changed the conclusion for fishpart_factor3 from rejecting the null hypothesis in the first model to failing to reject it in the second model.
...
#fish.demo$TotHg.BC <-   # Complete this line
...
#lambda_best <- 0.3434343
#TotHg <- 4.484  

#TotHg_BC <- (TotHg^lambda_best - 1) / lambda_best
...
#fish.reg.BC <- # Complete this line
